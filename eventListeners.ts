...
function clickItem(dropdownId: string) {
    if (document.getElementById(dropdownId).style.display == 'none' || document.getElementById(dropdownId).style.display == '') document.getElementById(dropdownId).style.display = 'block';
